...
def reserse_Data(download_data):
...
def load_data():
    ...
    command = (
        ...
        CREATE TEMPORARY TABLE IF NOT EXISTS staging_surf_report (
            ...
            surf_optimalScore INTEGER NULL,
            surf_plus BOOL NOT NULL,
            surf_humanRelation VARCHAR(255) NULL,
            surf_raw_min NUMERIC,
            surf_raw_max NUMERIC,
            speed NUMERIC,
            direction NUMERIC NULL,
            directionType VARCHAR(255) NULL,
            gust NUMERIC NULL,
            optimalScore INTEGER NULL,
